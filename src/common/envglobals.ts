...
export function envglobals() : globalValues {
        ...
        switch(hostname) {
            ...
            case "app-dev.geo.ca":   
                return {
                    LOGO_SITE_LINK_URL: { 
                        "en-CA": "https://dev.geo.ca/home/index.html",
                        "fr-CA": "https://dev.geo.ca/fr/accueil/index.html"
                    },    
            ...
            case "app-stage.geo.ca":
                return {
                    LOGO_SITE_LINK_URL: { 
                        "en-CA": "https://stage.geo.ca/home/index.html",
                        "fr-CA": "https://stage.geo.ca/fr/accueil/index.html"
                    },    
            ...
            case "app.geo.ca":
                return {
                    LOGO_SITE_LINK_URL: { 
                        "en-CA": "https://geo.ca/home/index.html",
                        "fr-CA": "https://geo.ca/fr/accueil/index.html"
                    },    
